...
const Header = () => {
  ...
  <div className="container-fluid">
    <Link className="navbar-brand ms-3 header-name" to="#">Niraj Singh</Link>
    ...
    <div className="collapse navbar-collapse justify-content-end" id="navbarNav">
      <ul className="navbar-nav ">
        ...
        <Link className="nav-link active" aria-current="page" to="Home"> <AiOutlineHome/>Home</Link>

        </li>
        <li className="nav-item active">
        <Link className="nav-link" to="Portfolio">< AiOutlineFundProjectionScreen/>Portfolio</Link>

        </li>
        <li className="nav-item active">
        <Link className="nav-link" to="Skills"><AiOutlineStar/>Skill</Link>

        </li>
        <li className="nav-item active">
        <Link className="nav-link" to="Contact"><AiOutlineUser/>Contact</Link>
...
<div className='AboutMe card-width  About' >
  ...
  <div className='aboutme-content aboutme-item2'>
      <h2>About Me</h2>
      <p>I'm Link web designer and front-end developer with 7 years of professional experience.
